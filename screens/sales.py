...
from components.theme import action_bar, flex_columns, INFO_BG, SUCCESS_BG, DARK_PRIMARY, WARNING_BG, ERROR_BG
...
class SalesScreen(MDScreen):
    ...
    def _build_ui(self):
        ...
        for st in ["Cotización","Pedido","Facturada","Pagada","Entregada","Cancelada"]:
            col = INFO_BG if st in ("Cotización","Pedido") else SUCCESS_BG if st=="Pagada" else DARK_PRIMARY if st=="Facturada" else WARNING_BG if st=="Entregada" else ERROR_BG
